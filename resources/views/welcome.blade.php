    ...
    <div class="container d-flex justify-content-between">
        <div class="card" style="width: 15rem;">
            ...
            <div class="card-body ">
                ...
                <a href="suivi" class="btn btn-primary mb-1" style="width: 100%;">Suivi commande</a>
        ...
        <div class="card" style="width: 15rem;">
            <img src="..." class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Plainte</h5>
                <a href="#" class="btn btn-primary mb-1" style="width: 100%;">Soumettre une plainte</a>
                <a href="#" class="btn btn-primary mb-1" style="width: 100%;">suivre plainte</a>
                <a href="#" class="btn btn-primary mb-1" style="width: 100%;">Soumettre proposition</a>
                <a href="#" class="btn btn-primary mb-1" style="width: 100%;">Go somewhere</a>
            </div>
        </div>
        <div class="card" style="width: 15rem;">
